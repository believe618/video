...
public interface BoxParser2 {
    Class<? extends Box2> getClassForFourCc(String type, byte[] userType, String parent);

    Box2 parseBox(ReadableByteChannel in, ContainerBox2 parent) throws IOException;
}
