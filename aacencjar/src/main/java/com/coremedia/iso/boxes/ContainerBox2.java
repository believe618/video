...
public interface ContainerBox2 extends Box2 {
     ...
     * @param box2s the new list of children
     */
    void setBox2s(List<Box2> box2s);
     ...
     * @return an array of boxes, empty array in case of no children.
     */
    <T extends Box2> List<T> getBoxes(Class<T> clazz);
     ...
     * @return an array of boxes, empty array in case of no children.
     */
    <T extends Box2> List<T> getBoxes(Class<T> clazz, boolean recursive);

    /**
     * Gets the parent box. May be <code>null</code> in case of the
     * {@link IsoFile2} itself.
     *
