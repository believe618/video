 ...
 * }
 */
public class MovieFragmentRandomAccessOffsetBox2 extends AbstractFullBox2 {
    public static final String TYPE = "mfro";
    private long mfraSize;

    public MovieFragmentRandomAccessOffsetBox2() {
        super(TYPE);
    }
    ...
    public void _parseDetails(ByteBuffer content) {
        ...
        mfraSize = IsoTypeReader2.readUInt32(content);
    }

    @Override
    protected void getContent(ByteBuffer byteBuffer) {
        writeVersionAndFlags(byteBuffer);
        IsoTypeWriter2.writeUInt32(byteBuffer, mfraSize);
    }
