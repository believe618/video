 ...
 * by the metadata (see {@link SampleTableBox2}).<br>
 ...
 * metadata refers to media data by its absolute offset within the file (see {@link StaticChunkOffsetBox2});
 ...
 */
public final class MediaDataBox2 implements Box2 {
    ...
    public void parse(ReadableByteChannel readableByteChannel, ByteBuffer header, long contentSize, BoxParser2 boxParser2) throws IOException {
        ...
        if (readableByteChannel instanceof FileChannel && contentSize > 1024 * 1024) {
            ...
            content = ChannelHelper2.readFully(readableByteChannel, l2i(contentSize));
        }
