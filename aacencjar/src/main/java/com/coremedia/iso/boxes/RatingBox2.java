 ...
 * PG13or FSK16.
 */
public class RatingBox2 extends AbstractFullBox2 {
    ...
    protected long getContentSize() {
        return 15 + Utf82.utf8StringLengthInBytes(ratingInfo);
    }

    @Override
    public void _parseDetails(ByteBuffer content) {
        parseVersionAndFlags(content);
        ratingEntity = IsoTypeReader2.read4cc(content);
        ratingCriteria = IsoTypeReader2.read4cc(content);
        language = IsoTypeReader2.readIso639(content);
        ratingInfo = IsoTypeReader2.readString(content);
    ...
    protected void getContent(ByteBuffer byteBuffer) {
        ...
        byteBuffer.put(IsoFile2.fourCCtoBytes(ratingEntity));
        byteBuffer.put(IsoFile2.fourCCtoBytes(ratingCriteria));
        IsoTypeWriter2.writeIso639(byteBuffer, language);
        byteBuffer.put(Utf82.convert(ratingInfo));
