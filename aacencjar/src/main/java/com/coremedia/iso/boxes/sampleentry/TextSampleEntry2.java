...
/*  class TextSampleEntry() extends SampleEntry ('tx3g') {
  ...
  */
    ...
    public TextSampleEntry2(String type) {
        super(type);
    }
    ...
    public void _parseDetails(ByteBuffer content) {
        ...
        displayFlags = IsoTypeReader2.readUInt32(content);
        horizontalJustification = IsoTypeReader2.readUInt8(content);
        verticalJustification = IsoTypeReader2.readUInt8(content);
        backgroundColorRgba = new int[4];
        backgroundColorRgba[0] = IsoTypeReader2.readUInt8(content);
        backgroundColorRgba[1] = IsoTypeReader2.readUInt8(content);
        backgroundColorRgba[2] = IsoTypeReader2.readUInt8(content);
        backgroundColorRgba[3] = IsoTypeReader2.readUInt8(content);
    ...
    protected void getContent(ByteBuffer byteBuffer) {
        ...
        IsoTypeWriter2.writeUInt32(byteBuffer, displayFlags);
        IsoTypeWriter2.writeUInt8(byteBuffer, horizontalJustification);
        IsoTypeWriter2.writeUInt8(byteBuffer, verticalJustification);
        IsoTypeWriter2.writeUInt8(byteBuffer, backgroundColorRgba[0]);
        IsoTypeWriter2.writeUInt8(byteBuffer, backgroundColorRgba[1]);
        IsoTypeWriter2.writeUInt8(byteBuffer, backgroundColorRgba[2]);
        IsoTypeWriter2.writeUInt8(byteBuffer, backgroundColorRgba[3]);
    ...
    public static class BoxRecord {
        ...
        public void parse(ByteBuffer in) {
            top = IsoTypeReader2.readUInt16(in);
            left = IsoTypeReader2.readUInt16(in);
            bottom = IsoTypeReader2.readUInt16(in);
            right = IsoTypeReader2.readUInt16(in);
        }

        public void getContent(ByteBuffer bb)  {
            IsoTypeWriter2.writeUInt16(bb, top);
            IsoTypeWriter2.writeUInt16(bb, left);
            IsoTypeWriter2.writeUInt16(bb, bottom);
            IsoTypeWriter2.writeUInt16(bb, right);
        }
    ...
    */
    public static class StyleRecord {
        ...
        public void parse(ByteBuffer in) {
            startChar = IsoTypeReader2.readUInt16(in);
            endChar = IsoTypeReader2.readUInt16(in);
            fontId = IsoTypeReader2.readUInt16(in);
            faceStyleFlags = IsoTypeReader2.readUInt8(in);
            fontSize = IsoTypeReader2.readUInt8(in);
            textColor = new int[4];
            textColor[0] = IsoTypeReader2.readUInt8(in);
            textColor[1] = IsoTypeReader2.readUInt8(in);
            textColor[2] = IsoTypeReader2.readUInt8(in);
            textColor[3] = IsoTypeReader2.readUInt8(in);
        }


        public void getContent(ByteBuffer bb) {
            IsoTypeWriter2.writeUInt16(bb, startChar);
            IsoTypeWriter2.writeUInt16(bb, endChar);
            IsoTypeWriter2.writeUInt16(bb, fontId);
            IsoTypeWriter2.writeUInt8(bb, faceStyleFlags);
            IsoTypeWriter2.writeUInt8(bb, fontSize);
            IsoTypeWriter2.writeUInt8(bb, textColor[0]);
            IsoTypeWriter2.writeUInt8(bb, textColor[1]);
            IsoTypeWriter2.writeUInt8(bb, textColor[2]);
            IsoTypeWriter2.writeUInt8(bb, textColor[3]);
        }
