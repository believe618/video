 ...
 * @see TrackBox2
 */
public class CopyrightBox2 extends AbstractFullBox2 {
    public static final String TYPE = "cprt";

    private String language;
    private String copyright;

    public CopyrightBox2() {
        super(TYPE);
    }
    ...
    protected long getContentSize() {
        return 7 + Utf82.utf8StringLengthInBytes(copyright);
    }
    ...
    public void _parseDetails(ByteBuffer content) {
        ...
        copyright = IsoTypeReader2.readString(content);
    }
    ...
    protected void getContent(ByteBuffer byteBuffer) {
        ...
        byteBuffer.put(Utf82.convert(copyright));
