 ...
 */
public class AudioSampleEntry22 extends SampleEntry2 implements ContainerBox2 {
    ...
    public AudioSampleEntry22(String type) {
        super(type);
    }
    ...
    public void setBoxParser(BoxParser2 boxParser) {
    ...
    public void _parseDetails(ByteBuffer content) {
        ...
        soundVersion = IsoTypeReader2.readUInt16(content);

        //reserved
        reserved1 = IsoTypeReader2.readUInt16(content);
        reserved2 = IsoTypeReader2.readUInt32(content);

        channelCount = IsoTypeReader2.readUInt16(content);
        sampleSize = IsoTypeReader2.readUInt16(content);
        //reserved bits - used by qt
        compressionId = IsoTypeReader2.readUInt16(content);
        //reserved bits - used by qt
        packetSize = IsoTypeReader2.readUInt16(content);
        //sampleRate = in.readFixedPoint1616();
        sampleRate = IsoTypeReader2.readUInt32(content);
        if (!type.equals("mlpa")) {
        ...
        if (soundVersion > 0) {
            samplesPerPacket = IsoTypeReader2.readUInt32(content);
            bytesPerPacket = IsoTypeReader2.readUInt32(content);
            bytesPerFrame = IsoTypeReader2.readUInt32(content);
            bytesPerSample = IsoTypeReader2.readUInt32(content);
        }
        if (soundVersion == 2) {
    ...
    protected void getContent(ByteBuffer byteBuffer) {
        ...
        IsoTypeWriter2.writeUInt16(byteBuffer, soundVersion);
        IsoTypeWriter2.writeUInt16(byteBuffer, reserved1);
        IsoTypeWriter2.writeUInt32(byteBuffer, reserved2);
        IsoTypeWriter2.writeUInt16(byteBuffer, channelCount);
        IsoTypeWriter2.writeUInt16(byteBuffer, sampleSize);
        IsoTypeWriter2.writeUInt16(byteBuffer, compressionId);
        IsoTypeWriter2.writeUInt16(byteBuffer, packetSize);
        //isos.writeFixedPont1616(getSampleRate());
        if (type.equals("mlpa")) {
            IsoTypeWriter2.writeUInt32(byteBuffer, getSampleRate());
        } else {
            IsoTypeWriter2.writeUInt32(byteBuffer, getSampleRate() << 16);
        }

        if (soundVersion > 0) {
            IsoTypeWriter2.writeUInt32(byteBuffer, samplesPerPacket);
            IsoTypeWriter2.writeUInt32(byteBuffer, bytesPerPacket);
            IsoTypeWriter2.writeUInt32(byteBuffer, bytesPerFrame);
            IsoTypeWriter2.writeUInt32(byteBuffer, bytesPerSample);
        }
