 ...
 */
public class TrackHeaderBox2 extends AbstractFullBox2 {
    ...
    public void _parseDetails(ByteBuffer content) {
        ...
        IsoTypeReader2.readUInt32(content);
        IsoTypeReader2.readUInt32(content);
        layer = IsoTypeReader2.readUInt16(content);    // 204
        alternateGroup = IsoTypeReader2.readUInt16(content);
        volume = IsoTypeReader2.readFixedPoint88(content);
        IsoTypeReader2.readUInt16(content);     // 212
        matrix = new long[9];
        for (int i = 0; i < 9; i++) {
            matrix[i] = IsoTypeReader2.readUInt32(content);
        }
        width = IsoTypeReader2.readFixedPoint1616(content);    // 248
        height = IsoTypeReader2.readFixedPoint1616(content);
    }
    ...
    public void getContent(ByteBuffer byteBuffer) {
        ...
        IsoTypeWriter2.writeUInt32(byteBuffer, 0);
        IsoTypeWriter2.writeUInt32(byteBuffer, 0);
        IsoTypeWriter2.writeUInt16(byteBuffer, layer);
        IsoTypeWriter2.writeUInt16(byteBuffer, alternateGroup);
        ...
        IsoTypeWriter2.writeFixedPont1616(byteBuffer, width);
        IsoTypeWriter2.writeFixedPont1616(byteBuffer, height);
    }
