 ...
 * }
 */
public class TrackFragmentHeaderBox2 extends AbstractFullBox2 {
    ...
    public TrackFragmentHeaderBox2() {
        super(TYPE);
    }
    ...
    protected void getContent(ByteBuffer byteBuffer) {
        ...
        if ((getFlags() & 0x1) == 1) { //baseDataOffsetPresent
            IsoTypeWriter2.writeUInt64(byteBuffer, getBaseDataOffset());
        }
        if ((getFlags() & 0x2) == 0x2) { //sampleDescriptionIndexPresent
            IsoTypeWriter2.writeUInt32(byteBuffer, getSampleDescriptionIndex());
        }
        if ((getFlags() & 0x8) == 0x8) { //defaultSampleDurationPresent
            IsoTypeWriter2.writeUInt32(byteBuffer, getDefaultSampleDuration());
        }
        if ((getFlags() & 0x10) == 0x10) { //defaultSampleSizePresent
            IsoTypeWriter2.writeUInt32(byteBuffer, getDefaultSampleSize());
        }
    ...
    public void _parseDetails(ByteBuffer content) {
        ...
        if ((getFlags() & 0x1) == 1) { //baseDataOffsetPresent
            baseDataOffset = IsoTypeReader2.readUInt64(content);
        }
        if ((getFlags() & 0x2) == 0x2) { //sampleDescriptionIndexPresent
            sampleDescriptionIndex = IsoTypeReader2.readUInt32(content);
        }
        if ((getFlags() & 0x8) == 0x8) { //defaultSampleDurationPresent
    ...
    public String toString() {
        ...
        sb.append(", defaultSampleFlags=").append(defaultSampleFlags2);
