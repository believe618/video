 ...
 */
public class MetaBox2 extends AbstractContainerBox2 {
    ...
    public void _parseDetails(ByteBuffer content) {
        ...
        String isHdlr = IsoTypeReader2.read4cc(content);
        if ("hdlr".equals(isHdlr)) {
            ...
            content.position(pos);
            version = IsoTypeReader2.readUInt8(content);
            flags = IsoTypeReader2.readUInt24(content);
        }
    ...
    protected void getContent(ByteBuffer byteBuffer) {
        if (isMp4Box()) {
            IsoTypeWriter2.writeUInt8(byteBuffer, version);
            IsoTypeWriter2.writeUInt24(byteBuffer, flags);
        }
