 ...
 * @see UserDataBox2
 */
public class AuthorBox2 extends AbstractFullBox2 {
    ...
    protected long getContentSize() {
        return 7 + Utf82.utf8StringLengthInBytes(author);
    }
    ...
    public void _parseDetails(ByteBuffer content) {
        ...
        author = IsoTypeReader2.readString(content);
    }
    ...
    protected void getContent(ByteBuffer byteBuffer) {
        ...
        byteBuffer.put(Utf82.convert(author));
