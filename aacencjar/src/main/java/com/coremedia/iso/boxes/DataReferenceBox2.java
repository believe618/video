 ...
 *
 * @see DataEntryUrlBox2
 * @see DataEntryUrnBox2
 */
public class DataReferenceBox2 extends FullContainerBox2 {

    public static final String TYPE = "dref";

    public DataReferenceBox2() {
        super(TYPE);
    ...
    protected void getContent(ByteBuffer byteBuffer) {
        ...
        IsoTypeWriter2.writeUInt32(byteBuffer, getBox2s().size());
