 ...
 */
public class TimeToSampleBox2 extends AbstractFullBox2 {
    public static final String TYPE = "stts";

    List<Entry> entries = Collections.emptyList();


    public TimeToSampleBox2() {
        super(TYPE);
    }
    ...
    public void _parseDetails(ByteBuffer content) {
        ...
        for (int i = 0; i < entryCount; i++) {
            entries.add(new Entry(IsoTypeReader2.readUInt32(content), IsoTypeReader2.readUInt32(content)));
        }
    ...
    protected void getContent(ByteBuffer byteBuffer) {
        ...
        for (Entry entry : entries) {
            ...
            IsoTypeWriter2.writeUInt32(byteBuffer, entry.getDelta());
        }
    }
     ...
     */
    public static long[] blowupTimeToSamples(List<TimeToSampleBox2.Entry> entries) {
        long numOfSamples = 0;
