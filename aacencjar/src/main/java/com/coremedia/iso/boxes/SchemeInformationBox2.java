 ...
 * boxexes whose type annd format are defined by the scheme declared in the {@link SchemeTypeBox2}.
 */
public class SchemeInformationBox2 extends AbstractContainerBox2 {
    public static final String TYPE = "schi";

    public SchemeInformationBox2() {
        super(TYPE);
    }
