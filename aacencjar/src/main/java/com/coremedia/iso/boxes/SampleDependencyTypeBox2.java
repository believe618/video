 ...
 * }
 */
public class SampleDependencyTypeBox2 extends AbstractFullBox2 {
    ...
    public SampleDependencyTypeBox2() {
        super(TYPE);
    }
    ...
    protected void getContent(ByteBuffer byteBuffer) {
        ...
        for (Entry entry : entries) {
            IsoTypeWriter2.writeUInt8(byteBuffer, entry.value);
        }
    }
    ...
    public void _parseDetails(ByteBuffer content) {
        ...
        while (content.remaining() > 0) {
            entries.add(new Entry(IsoTypeReader2.readUInt8(content)));
        }
    }
