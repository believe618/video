...
public class MovieExtendsHeaderBox2 extends AbstractFullBox2 {
    ...
    public void _parseDetails(ByteBuffer content) {
        ...
        fragmentDuration = getVersion() == 1 ? IsoTypeReader2.readUInt64(content) : IsoTypeReader2.readUInt32(content);
    }
    ...
    protected void getContent(ByteBuffer byteBuffer) {
        ...
        if (getVersion() == 1) {
            IsoTypeWriter2.writeUInt64(byteBuffer, fragmentDuration);
        } else {
            IsoTypeWriter2.writeUInt32(byteBuffer, fragmentDuration);
        }
    }
