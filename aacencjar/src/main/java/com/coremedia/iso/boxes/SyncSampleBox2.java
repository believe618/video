 ...
 */
public class SyncSampleBox2 extends AbstractFullBox2 {
    public static final String TYPE = "stss";

    private long[] sampleNumber;

    public SyncSampleBox2() {
        super(TYPE);
    }
    ...
    public void _parseDetails(ByteBuffer content) {
        ...
        for (int i = 0; i < entryCount; i++) {
            sampleNumber[i] = IsoTypeReader2.readUInt32(content);
        }
    }
    ...
    protected void getContent(ByteBuffer byteBuffer) {
        ...
        IsoTypeWriter2.writeUInt32(byteBuffer, sampleNumber.length);

        for (long aSampleNumber : sampleNumber) {
            IsoTypeWriter2.writeUInt32(byteBuffer, aSampleNumber);
        }
