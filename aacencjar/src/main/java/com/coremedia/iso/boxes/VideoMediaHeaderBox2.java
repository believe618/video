 ...
 */
public class VideoMediaHeaderBox2 extends AbstractMediaHeaderBox2 {
    private int graphicsmode = 0;
    private int[] opcolor = new int[]{0, 0, 0};
    public static final String TYPE = "vmhd";

    public VideoMediaHeaderBox2() {
        super(TYPE);
    ...
    public void _parseDetails(ByteBuffer content) {
        ...
        graphicsmode = IsoTypeReader2.readUInt16(content);
        opcolor = new int[3];
        for (int i = 0; i < 3; i++) {
            opcolor[i] = IsoTypeReader2.readUInt16(content);
        }
    }
    ...
    protected void getContent(ByteBuffer byteBuffer) {
        ...
        IsoTypeWriter2.writeUInt16(byteBuffer, graphicsmode);
        for (int anOpcolor : opcolor) {
            IsoTypeWriter2.writeUInt16(byteBuffer, anOpcolor);
        }
    }
