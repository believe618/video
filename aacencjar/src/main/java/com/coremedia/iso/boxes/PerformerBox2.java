 ...
 */
public class PerformerBox2 extends AbstractFullBox2 {
    public static final String TYPE = "perf";

    private String language;
    private String performer;

    public PerformerBox2() {
        super(TYPE);
    }
    ...
    protected long getContentSize() {
        return 6 + Utf82.utf8StringLengthInBytes(performer) + 1;
    }
    ...
    protected void getContent(ByteBuffer byteBuffer) {
        ...
        byteBuffer.put(Utf82.convert(performer));
    ...
    public void _parseDetails(ByteBuffer content) {
        ...
        performer = IsoTypeReader2.readString(content);
    }
