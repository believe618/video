...
public class SampleFlags2 {
    ...
    public SampleFlags2(ByteBuffer bb) {
    ...
    public void getContent(ByteBuffer os) {
        BitWriterBuffer2 bitWriterBuffer2 = new BitWriterBuffer2(os);
        bitWriterBuffer2.writeBits(reserved, 6);
        bitWriterBuffer2.writeBits(sampleDependsOn, 2);
        bitWriterBuffer2.writeBits(sampleIsDependedOn, 2);
        bitWriterBuffer2.writeBits(sampleHasRedundancy, 2);
        bitWriterBuffer2.writeBits(samplePaddingValue, 3);
        bitWriterBuffer2.writeBits(this.sampleIsDifferenceSample ? 1 : 0, 1);
        bitWriterBuffer2.writeBits(sampleDegradationPriority, 16);
    }
    ...
    public boolean equals(Object o) {
        ...
        SampleFlags2 that = (SampleFlags2) o;
