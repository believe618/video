 ...
 * <code>
 * Box Type  : 'elst'<br>
 * Container: {@link EditBox2}('edts')<br>
 * Mandatory: No<br>
 ...
 * <li>Media-Rate = 1</li>
 */
public class EditListBox2 extends AbstractFullBox2 {
    ...
    public static class Entry {
         ...
         */
        public Entry(EditListBox2 editListBox, long segmentDuration, long mediaTime, double mediaRate) {
        ...
        public Entry(EditListBox2 editListBox, ByteBuffer bb) {
            if (editListBox.getVersion() == 1) {
                segmentDuration = IsoTypeReader2.readUInt64(bb);
                mediaTime = IsoTypeReader2.readUInt64(bb);
                mediaRate = IsoTypeReader2.readFixedPoint1616(bb);
            } else {
                segmentDuration = IsoTypeReader2.readUInt32(bb);
                mediaTime = IsoTypeReader2.readUInt32(bb);
                mediaRate = IsoTypeReader2.readFixedPoint1616(bb);
            }
            this.editListBox = editListBox;
        }
        ...
        public void getContent(ByteBuffer bb)  {
            if (editListBox.getVersion() == 1) {
                IsoTypeWriter2.writeUInt64(bb, segmentDuration);
                IsoTypeWriter2.writeUInt64(bb, mediaTime);
            } else {
                IsoTypeWriter2.writeUInt32(bb, l2i(segmentDuration));
                bb.putInt(l2i(mediaTime));
            }
            IsoTypeWriter2.writeFixedPont1616(bb, mediaRate);
        }
