...
public class DTSSpecificBox2 extends AbstractBox2 {
    ...
    public void _parseDetails(ByteBuffer content) {
        DTSSamplingFrequency = IsoTypeReader2.readUInt32(content);
        maxBitRate = IsoTypeReader2.readUInt32(content);
        avgBitRate = IsoTypeReader2.readUInt32(content);
        pcmSampleDepth = IsoTypeReader2.readUInt8(content);
    ...
    protected void getContent(ByteBuffer byteBuffer) {
        IsoTypeWriter2.writeUInt32(byteBuffer, DTSSamplingFrequency);
        IsoTypeWriter2.writeUInt32(byteBuffer, maxBitRate);
        IsoTypeWriter2.writeUInt32(byteBuffer, avgBitRate);
        IsoTypeWriter2.writeUInt8(byteBuffer, pcmSampleDepth);
