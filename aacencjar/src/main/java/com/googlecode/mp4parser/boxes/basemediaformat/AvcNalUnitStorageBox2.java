 ...
 */
public class AvcNalUnitStorageBox2 extends AbstractBox2 {
    byte[] data;

    public AvcNalUnitStorageBox2() {
        super("avcn");
    }


    public AvcNalUnitStorageBox2(AvcConfigurationBox2 avcConfigurationBox) {
        super("avcn");
