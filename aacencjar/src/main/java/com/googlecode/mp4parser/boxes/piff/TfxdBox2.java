...
public class TfxdBox2 extends AbstractFullBox2 {
    ...
    public void _parseDetails(ByteBuffer content) {
        ...
        if (getVersion() == 0x01) {
            fragmentAbsoluteTime = IsoTypeReader2.readUInt64(content);
            fragmentAbsoluteDuration = IsoTypeReader2.readUInt64(content);
        } else {
            fragmentAbsoluteTime = IsoTypeReader2.readUInt32(content);
            fragmentAbsoluteDuration = IsoTypeReader2.readUInt32(content);
        }
    }
    ...
    protected void getContent(ByteBuffer byteBuffer) {
        ...
        if (getVersion() == 0x01) {
            IsoTypeWriter2.writeUInt64(byteBuffer, fragmentAbsoluteTime);
            IsoTypeWriter2.writeUInt64(byteBuffer, fragmentAbsoluteDuration);
        } else {
            IsoTypeWriter2.writeUInt32(byteBuffer, fragmentAbsoluteTime);
            IsoTypeWriter2.writeUInt32(byteBuffer, fragmentAbsoluteDuration);
        }
    }
