 ...
 * }
 */
@Descriptor2(tags = {0x06})
public class SLConfigDescriptor2 extends BaseDescriptor2 {
    int predefined;
    ...
    public void parseDetail(ByteBuffer bb) throws IOException {
        predefined =  IsoTypeReader2.readUInt8(bb);
    }
    ...
    public ByteBuffer serialize() {
        ...
        IsoTypeWriter2.writeUInt8(out, 6);
        IsoTypeWriter2.writeUInt8(out, 1);
        IsoTypeWriter2.writeUInt8(out, predefined);
        return out;
    }
