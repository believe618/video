 ...
 */
public class PlayReadyHeader22 extends ProtectionSpecificHeader2 {
    private long length;
    private List<PlayReadyRecord> records;

    public PlayReadyHeader22() {
   ...
   PlayReady Records See Text Varies
        ...
        */
        ...
        length = IsoTypeReader2.readUInt32BE(byteBuffer);
        int recordCount = IsoTypeReader2.readUInt16BE(byteBuffer);
    ...
    public ByteBuffer getData() {
        ...
        IsoTypeWriter2.writeUInt32BE(byteBuffer, size);
        IsoTypeWriter2.writeUInt16BE(byteBuffer, records.size());
        for (PlayReadyRecord record : records) {
            IsoTypeWriter2.writeUInt16BE(byteBuffer, record.type);
            IsoTypeWriter2.writeUInt16BE(byteBuffer, record.getValue().limit());
    ...
    public static abstract class PlayReadyRecord {
        ...
        public static List<PlayReadyRecord> createFor(ByteBuffer byteBuffer, int recordCount) {
            ...
            for (int i = 0; i < recordCount; i++) {
                ...
                int type = IsoTypeReader2.readUInt16BE(byteBuffer);
                int length = IsoTypeReader2.readUInt16BE(byteBuffer);
                switch (type) {
                    case 0x1:
                        record = new RMHeader();
                        break;
