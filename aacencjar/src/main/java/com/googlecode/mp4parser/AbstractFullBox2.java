...
public abstract class AbstractFullBox2 extends AbstractBox2 implements FullBox2 {
    ...
    protected AbstractFullBox2(String type) {
        super(type);
    }

    protected AbstractFullBox2(String type, byte[] userType) {
        super(type, userType);
    }
    ...
    protected final void writeVersionAndFlags(ByteBuffer bb) {
        IsoTypeWriter2.writeUInt8(bb, version);
        IsoTypeWriter2.writeUInt24(bb, flags);
    }
}
