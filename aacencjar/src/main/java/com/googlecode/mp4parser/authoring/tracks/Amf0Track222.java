...
import com.googlecode.mp4parser.boxes.adobe.ActionMessageFormat0SampleEntry2Box2;
...
public class Amf0Track222 extends AbstractTrack22 {
     ...
     * @param rawSamples
     */
    public Amf0Track222(Map<Long, byte[]> rawSamples) {
    ...
    public SampleDescriptionBox2 getSampleDescriptionBox() {
        SampleDescriptionBox2 stsd = new SampleDescriptionBox2();
        ActionMessageFormat0SampleEntry2Box2 amf0 = new ActionMessageFormat0SampleEntry2Box2();
    ...
    public List<TimeToSampleBox2.Entry> getDecodingTimeEntries() {
        LinkedList<TimeToSampleBox2.Entry> timesToSample = new LinkedList<TimeToSampleBox2.Entry>();
        ...
        for (Long key : keys) {
            ...
            if (timesToSample.size() > 0 && timesToSample.peek().getDelta() == delta) {
                ...
                timesToSample.add(new TimeToSampleBox2.Entry(1, delta));
            }
            lastTimeStamp = key;
        }
