...
import com.googlecode.mp4parser.boxes.AC3SpecificBox2;
...
public class AC3Track22Impl2 extends AbstractTrack22 {
    ...
    public AC3Track22Impl2(InputStream fin) throws IOException {
        inputStream = fin;
        ...
        AudioSampleEntry22 audioSampleEntry2 = new AudioSampleEntry22("ac-3");
        ...
        AC3SpecificBox2 ac3 = new AC3SpecificBox2();
        ac3.setAcmod(acmod);
